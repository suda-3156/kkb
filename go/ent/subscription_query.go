...
type SubscriptionQuery struct {
	...
	withTemplateEntries *SubscriptionEntryQuery
	withOccurrences     *SubscriptionOccurrenceQuery
...
// QueryTemplateEntries chains the current query on the "template_entries" edge.
func (_q *SubscriptionQuery) QueryTemplateEntries() *SubscriptionEntryQuery {
...
func (_q *SubscriptionQuery) QueryOccurrences() *SubscriptionOccurrenceQuery {
	query := (&SubscriptionOccurrenceClient{config: _q.config}).Query()
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		if err := _q.prepareQuery(ctx); err != nil {
			return nil, err
		}
...
func (_q *SubscriptionQuery) QueryTransactions() *TransactionQuery {
...
func (_q *SubscriptionQuery) QueryEncryptionKey() *LedgerEncryptionKeyQuery {
...
func (_q *SubscriptionQuery) Clone() *SubscriptionQuery {
	...
	return &SubscriptionQuery{
		...
		withTemplateEntries: _q.withTemplateEntries.Clone(),
...
// WithTemplateEntries tells the query-builder to eager-load the nodes that are connected to
// the "template_entries" edge. The optional arguments are used to configure the query builder of the edge.
func (_q *SubscriptionQuery) WithTemplateEntries(opts ...func(*SubscriptionEntryQuery)) *SubscriptionQuery {
	query := (&SubscriptionEntryClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
	_q.withTemplateEntries = query
	return _q
}
...
func (_q *SubscriptionQuery) WithOccurrences(opts ...func(*SubscriptionOccurrenceQuery)) *SubscriptionQuery {
	query := (&SubscriptionOccurrenceClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *SubscriptionQuery) WithTransactions(opts ...func(*TransactionQuery)) *SubscriptionQuery {
	query := (&TransactionClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *SubscriptionQuery) WithEncryptionKey(opts ...func(*LedgerEncryptionKeyQuery)) *SubscriptionQuery {
	query := (&LedgerEncryptionKeyClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
//		GroupBy(subscription.FieldPublicID).
//		Aggregate(ent.Count()).
//		Scan(ctx, &v)
...
//
//	client.Subscription.Query().
//		Select(subscription.FieldPublicID).
//		Scan(ctx, &v)
...
func (_q *SubscriptionQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Subscription, error) {
	...
	if query := _q.withTemplateEntries; query != nil {
		if err := _q.loadTemplateEntries(ctx, query, nodes,
			func(n *Subscription) { n.Edges.TemplateEntries = []*SubscriptionEntry{} },
			func(n *Subscription, e *SubscriptionEntry) {
				n.Edges.TemplateEntries = append(n.Edges.TemplateEntries, e)
			}); err != nil {
			return nil, err
		}
	}
	if query := _q.withOccurrences; query != nil {
		if err := _q.loadOccurrences(ctx, query, nodes,
			func(n *Subscription) { n.Edges.Occurrences = []*SubscriptionOccurrence{} },
			func(n *Subscription, e *SubscriptionOccurrence) { n.Edges.Occurrences = append(n.Edges.Occurrences, e) }); err != nil {
			return nil, err
		}
	}
	if query := _q.withTransactions; query != nil {
		if err := _q.loadTransactions(ctx, query, nodes,
			func(n *Subscription) { n.Edges.Transactions = []*Transaction{} },
			func(n *Subscription, e *Transaction) { n.Edges.Transactions = append(n.Edges.Transactions, e) }); err != nil {
			return nil, err
		}
	}
	if query := _q.withEncryptionKey; query != nil {
		if err := _q.loadEncryptionKey(ctx, query, nodes, nil,
			func(n *Subscription, e *LedgerEncryptionKey) { n.Edges.EncryptionKey = e }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (_q *SubscriptionQuery) loadTemplateEntries(ctx context.Context, query *SubscriptionEntryQuery, nodes []*Subscription, init func(*Subscription), assign func(*Subscription, *SubscriptionEntry)) error {
	...
	query.Where(predicate.SubscriptionEntry(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(subscription.TemplateEntriesColumn), fks...))
	}))
	...
	for _, n := range neighbors {
		fk := n.subscription_template_entries
		if fk == nil {
			return fmt.Errorf(`foreign-key "subscription_template_entries" is nil for node %v`, n.ID)
		}
		node, ok := nodeids[*fk]
		if !ok {
			return fmt.Errorf(`unexpected referenced foreign-key "subscription_template_entries" returned %v for node %v`, *fk, n.ID)
		}
		assign(node, n)
	}
	return nil
}
func (_q *SubscriptionQuery) loadOccurrences(ctx context.Context, query *SubscriptionOccurrenceQuery, nodes []*Subscription, init func(*Subscription), assign func(*Subscription, *SubscriptionOccurrence)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[int]*Subscription)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
	...
	query.withFKs = true
	query.Where(predicate.SubscriptionOccurrence(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(subscription.OccurrencesColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
	...
	for _, n := range neighbors {
		fk := n.subscription_occurrences
		if fk == nil {
			return fmt.Errorf(`foreign-key "subscription_occurrences" is nil for node %v`, n.ID)
		}
		node, ok := nodeids[*fk]
		if !ok {
			return fmt.Errorf(`unexpected referenced foreign-key "subscription_occurrences" returned %v for node %v`, *fk, n.ID)
		}
		assign(node, n)
	}
	return nil
}
func (_q *SubscriptionQuery) loadTransactions(ctx context.Context, query *TransactionQuery, nodes []*Subscription, init func(*Subscription), assign func(*Subscription, *Transaction)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[int]*Subscription)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
	...
	query.Where(predicate.Transaction(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(subscription.TransactionsColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
	...
	for _, n := range neighbors {
		fk := n.subscription_transactions
		if fk == nil {
			return fmt.Errorf(`foreign-key "subscription_transactions" is nil for node %v`, n.ID)
		}
		node, ok := nodeids[*fk]
		if !ok {
			return fmt.Errorf(`unexpected referenced foreign-key "subscription_transactions" returned %v for node %v`, *fk, n.ID)
		}
		assign(node, n)
	}
	return nil
}
func (_q *SubscriptionQuery) loadEncryptionKey(ctx context.Context, query *LedgerEncryptionKeyQuery, nodes []*Subscription, init func(*Subscription), assign func(*Subscription, *LedgerEncryptionKey)) error {
	ids := make([]int, 0, len(nodes))
	nodeids := make(map[int][]*Subscription)
	for i := range nodes {
		if nodes[i].ledger_encryption_key_subscriptions == nil {
			continue
		}
		fk := *nodes[i].ledger_encryption_key_subscriptions
	...
	for _, n := range neighbors {
		...
		if !ok {
			return fmt.Errorf(`unexpected foreign-key "ledger_encryption_key_subscriptions" returned %v`, n.ID)
		}
		for i := range nodes {
			assign(nodes[i], n)
		}
