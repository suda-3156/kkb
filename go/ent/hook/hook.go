...
// The LedgerEncryptionKeyFunc type is an adapter to allow the use of ordinary
// function as LedgerEncryptionKey mutator.
type LedgerEncryptionKeyFunc func(context.Context, *ent.LedgerEncryptionKeyMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f LedgerEncryptionKeyFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.LedgerEncryptionKeyMutation); ok {
		return f(ctx, mv)
	}
